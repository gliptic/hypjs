...
return d({b:function(){return b}},function(c){if(!a||a(c))return b=c,!0})}},sample:function(a){return function(b){var c;v(a).some(function(){return b(c)});return d(b,function(a){c=a})}},delay:function(a){return function(b){return d(b,function(c){w(a).some(function(){return b(c)})})}},timegaps:function(){return function(a){var b=m.now();return d(a,function(c){var e=m.now(),d=e-b;b=e;return a({v:c,gap:d})})}},timestamp:function(){return function(a){return d(a,function(b){return a({v:b,t:m.now()})})}},
...
g.sum=function(){return this.fold(A,0)};g.lazy=function(){var a=q(this.c);if(!this.f)return a;var b=[],c=0,e=this.f(n(b)),f=d(e,{next:function(){for(;c===b.length;){b.length=c=0;var d=a.next();if(d.done)return{done:!0};e(d.value)}return{value:b[c++]}}});f[l]=function(){return f};return f};return h});
